...
const FEATURES_ES = [
  ...
  'DiseÃ±ado segÃºn tus objetivos y disponibilidad',
  'ComunicaciÃ³n directa con Vicky vÃ­a WhatsApp',
  'Ajustes mensuales segÃºn tu progreso',
...
export default function EntrenConmigoPage() {
  ...
  const vickyQuote = lang === 'es' 
    ? 'Te harÃ© tu entrenamiento personalizado segÃºn tus necesidades y objetivos, cargÃ¡ndote semanalmente tus Ã©ntrenos en la web para hacer tu rutina en tu tiempo, teniendo diariamente si es necesario contacto a travÃ©s de mi WhatsApp personal y una videollamada mensual gratuita, "mi objetivo serÃ¡s tu"'
      ...
      <section className="relative w-full h-[60vh] min-h-[450px] flex flex-col justify-end pb-12 px-6">
        <div className="absolute inset-0 w-full h-full">
          <Image
            ...
            alt="Entrena Conmigo â€” Vicky Torres"
            fill
            priority
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-12">
          ...
          <div className="bg-surface rounded-[2rem] p-8 md:p-12 border border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-white italic uppercase tracking-tight mb-8 relative z-10">
              {lang === 'es' ? 'Â¿QuÃ© incluye?' : "What's included?"}
            </h2>
          ...
          <div className="relative py-8 md:py-12 px-8 bg-copper/5 border-l-4 border-copper rounded-r-3xl overflow-hidden">
            <span className="absolute top-4 left-4 text-copper/10 text-8xl font-serif select-none">â€œ</span>
            <p className="text-zinc-200 text-lg md:text-2xl font-bold italic leading-relaxed relative z-10">
              {vickyQuote.split('"mi objetivo serÃ¡s tu"')[0]}
              <span className="text-copper font-black block mt-4 md:inline md:mt-0">
                "{lang === 'es' ? 'mi objetivo serÃ¡s tu' : 'my goal will be you'}"
              </span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                icon: 'ðŸ“‹',
                title_es: 'RespondÃ©s el onboarding',
                desc_es: 'Cuatro preguntas sobre tus objetivos, dÃ­as disponibles y equipamiento.',
                title_en: 'Complete onboarding',
                desc_en: 'Four questions about your goals, available days and equipment.',
              },
              {
                icon: 'âš¡',
                title_es: 'Vicky diseÃ±a tu plan',
                desc_es: 'En 24-48hs tenÃ©s tu entrenamiento 100% personalizado listo.',
                title_en: 'Vicky designs your plan',
                desc_en: 'Within 24-48hs your 100% personalized training plan is ready.',
              },
              {
                icon: 'ðŸ’ª',
                title_es: 'EntrenÃ¡s con Vicky',
