...
export default function CompleteDayButton({ dayNumber, allCompleted, weekNumber }: { dayNumber: number, allCompleted: boolean, weekNumber: number }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full p-6 bg-carbon/90 backdrop-blur-xl border-t border-white/5 z-50 md:static md:bg-transparent md:border-none md:p-8 md:flex md:justify-center animate-in fade-in slide-in-from-bottom-8 duration-500">
      <button 
